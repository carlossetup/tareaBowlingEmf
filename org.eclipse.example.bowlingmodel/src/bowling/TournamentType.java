...
public enum TournamentType implements Enumerator {
	 ...
	 * @ordered
	 */
	PROFESIONAL(1, "Profesional", "Profesional");
	 ...
	 * <!-- end-user-doc -->
	 * @see #AMATEUR
	 * @model name="Amateur" literal="Ameteur"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @ordered
	 */
	public static final int PROFESIONAL_VALUE = 1;
	...
	public static TournamentType get(int value) {
		switch (value) {
			...
			case PROFESIONAL_VALUE: return PROFESIONAL;
		}
		return null;
	}
