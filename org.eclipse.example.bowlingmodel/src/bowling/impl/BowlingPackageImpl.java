...
public class BowlingPackageImpl extends EPackageImpl implements BowlingPackage {
	 ...
	 * @generated
	 */
	public EAttribute getPlayer_DateOfBird() {
	...
	public void createPackageContents() {
		...
		createEAttribute(playerEClass, PLAYER__DATE_OF_BIRD);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPlayer_DateOfBird(), ecorePackage.getEDate(), "DateOfBird", null, 0, 1, Player.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(tournamentTypeEEnum, TournamentType.PROFESIONAL);
